...
7. Create the following string as the value of the **webhookuri** Function App setting:
```
[{"channel":"<Name of Teams Channel>,"uri":"https://uri_of_teams_channel_webhook"}]
```
Application settings are visible to the function as environment variables.
